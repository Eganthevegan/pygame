...
def msg():
    MsgBox = messagebox.showinfo("Alert", "do you want to caculate the denomination count?")
...
def topwin():
    top = Toplevel()
    top.title("Denomination Caculator")
    ...
    btn = Button(top, text="Caculate", command=caculator, bg="brown", fg="white")
